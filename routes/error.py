...
def custom_400_errorhandler(error):
    """
...
def custom_401_errorhandler(error):
    """
...
def custom_403_errorhandler(error):
    """
...
def custom_404_errorhandler(error):
    """
...
def custom_429_errorhandler(error):
    """
...
def custom_500_errorhandler(error):
    """
...
def custom_502_errorhandler(error):
    """
...
def custom_503_errorhandler(error):
    """
...
def custom_504_errorhandler(error):
    """
